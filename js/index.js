...
//         icon: "error",
//         title: "Oops...",
//         text: "There was some error, contact EmpowerShe@gmail.com.",
//       })
//     });
...
// fetch(`https://api.opencagedata.com/geocode/v1/json?q=${position.coords.latitude}+${position.coords.longitude}&key=277a9058bf4c4217954da0d0393d3d43`)
//     .then(res => res.json())
//     .then(res => {
